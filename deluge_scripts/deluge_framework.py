...
# Modified By: John B. (u/JagaTelesin on reddit)
# - Changes to add a custom deluge_login, and toggle-able output via variable ('interactive')
# - This file remains under the GNU v2.0 License:
# - https://github.com/BackSlasher/deluge_framework/blob/master/LICENSE
...
from variables import deluge_port, output
import logging
...
def filter_torrents(connection_data={},info_wanted=[],action=(lambda tid,tinfo: 'l'),interactive=output):
    ...
    # set parameters
    global cliconnect
    cliconnect = client.connect(port=deluge_port)
